...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported confidentially using
[PipeLens private reporting](https://github.com/sangmu1126/PipeLens/security/advisories/new). Begin the
report title with `Code of Conduct`. This private channel accepts conduct reports even when no software
vulnerability is involved. Do not include the reporter's or another person's private information beyond
what is necessary to investigate the incident.
